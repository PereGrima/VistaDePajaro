...
|                                                                                | -   Solo sirve para regresión simple                                            |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
: Método de Ishikawa. Ventajas e inconvenientes {#tbl-letters}
: {tbl-colwidths="\[10,90\]"}
...
![Dos ajustes -claramente muy malos- con suma de residuos igual a cero.](ScriptsR/sumaValorAbsoluto.png){fig-align="center" width="100%" #fig-sumaCero}

+--------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+
| **PROS** <i class="fa-solid fa-thumbs-up fa-xl" style="color: #0ca701;"></i>   | -   Ninguno                                                                                         |
|                                                                                |                                                                                                     |
+--------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+
...
|                                                                                |                                                                                                     |
+--------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+
: Minimizar la suma de los residups. Ventajas e inconvenientes {#tbl-letters}
: {tbl-colwidths="\[10,90\]"}


### Minimizando la suma de los residuos en valor absoluto {.unnumbered}

De entrada parece bastante más razonable que el anterior. Tiene solución única pero el manejo de la función "valor absoluto" es no existe una expresión analítica para determinarla (c
sí la habrá cuando el objetivo sea minimizar la suma de los cuadrados de los residuos) esta debe hallarse ****POR AQUÍ VOY****
