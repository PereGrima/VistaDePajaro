...
::: callout-note
## Chistes a base de ignorar la variabilidad
...
$$ a = \sum_{i=1}^{N} \frac{x_i}{N} $$ En este caso el valor de $a$ sí coincide con la media aritmética (le llamamos ($\mu$). Si hacemos la segunda derivada vemos que siempre es positiva, lo cual confirma que el punto crítico es $a=\mu$ y que el valor mínimo de $g(a)$ es la varianza de $X$.
