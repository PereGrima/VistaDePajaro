...
Simplemente elevamos las diferencias al cuadrado en vez de usar su valor absoluto. Si tenemos un conjunto de $N$ datos con media $\mu$ y queremos conocer la varianza de **esos datos**[^1] usamos la expresión:

[^1]: leyenda nota pie de página

$$ \sigma^2 = \frac{\sum_{i=1}^N ( x_i - \mu )^2}{N} $$ 
Repitiendo el análisis que hemos hecho para la $DM$, vamos a elegir el valor de $a$ que minimiza la función:

$$g(a) =  \frac{\sum_{i=1}^N ( x_i - a )^2}{N} $$ 
En este caso lo podemos deducir derivando $g(a)$ con respecto a $a$, igualando a cero y despejando su valor. Veamos:
...
$$CV = \frac{s}{\bar{x}}$$
Con frecuentcia ese valor se multiplica por 100 para darlo como porcentaje. Ennuestro ejemplo, para los gatos tenemos un $CV$ del 65,35% mientras que para las vacas es solo del 1,83%.
...
Ordenados los datos de menor a mayor, la mediana es el que los separa en dos mitades. El primer cuartil es la mediana de la primera mitad dejando, por tanto, el 25% de valores por debajo y el 75% por encima. La mediana de la segunda mitad es el tercer cuartil, que deja el 75% por debajo y el 25% por encima.

![Esquema de obtención de la mediana y los cuartiles en un conjunto de 30 datos ===pensar en poner color===](sintesisNumerica/cuartiles.png){#fig-cuartiles fig-align="center" width="100%"}

Si usted conoce la mediana y los cuartiles de los salarios de su empresa, puede posicionar facilmente el suyo. Si el primer cuartil es 1.300€, la mediana 1.500€ y el tercer cuartil 1.800€, si usted cobra 1.400€ está entre el 25% que menos gana. Si su salario es de 1.600€ está en entre la mitad de los que más ganan pero como mínimo el 25% de los empleados gana más que usted. Si cobra 2.000€ está entre el 25% de privilegiados que más ganan.

###### **¿Cómo se calculan los cuartiles?** {.unnumbered}
...
![](sintesisNumerica/Cuartiles_1.png){fig-align="center" width="65%"} 

Y si los datos son 2, 4, 6, y 8 (número par):

![](sintesisNumerica/Cuartiles_2.png){fig-align="center" width="65%"}
...
![](sintesisNumerica/Cuartiles_3.png){fig-align="center" width="65%"}
...
```{=html}
<h8>
    <table width=100%" cellpadding="10"  border="0" class="center">
    <tr style="border-bottom:0.5px solid grey">
    <!-- <td colspan="100%"></td> -->
  </tr>
        <tr>
            <td style="text-align:center">Datos</td>
            <td style="text-align:center">Posición Q1</td>
            <td style="text-align:center">Valor Q1</td>
            <td style="text-align:center">Posición Q3</td>
            <td style="text-align:center">Valor Q3</td>
        </tr>
        
        <tr style="border-bottom:0.5px solid grey">
    
        <tr>
            <td style="text-align:center">2, 4, 6, 8 (n=4)<br> 2, 4, 6, 8, 10 (n=5)</td>
            <td style="text-align:center">0.25·5=1.25 <br>0.25·6=1.5</td>
            <td style="text-align:center">2+0.25(4-2) = <p><b>2.5</b> <br>2+0.5(4-2) = <b>3</b></td>
            <td style="text-align:center">0.75·5=3.75 <br>0.75·6  =4.5</td>
            <td style="text-align:center">6+0.75(8-6) = <b>7.5</b> <br>8+0.5(10-8) = <b>9</b></td>
        </tr>
...
<!-- \vspace{0.5cm} -->
<!-- \noindent $ \bullet \;$ Datos: 2, 4, 6, 8, 10 \\ -->
<!-- Posición de \(Q_1:\) \(0,25\cdot6=1,5\); Valor de \(Q_1:\) \(2+0,5(4-2)=3\) \\ -->
<!-- Posición de \(Q_3:\) \(0,75\cdot6=4,5\); Valor de \(Q_3:\) \(8+0,5(10-8)=9\)  -->

<!-- \vspace{0.3cm} -->
<!-- \noindent $ \bullet \;$ Datos: 2, 4, 6, 8 \\ -->
<!-- Posición  \(Q_1:\) \(0,25\cdot5=1,25\); Valor  \(Q_1:\) \(2+0,25(4-2)=2,5\) \\ -->
<!-- Posición  \(Q_3:\) \(0,75\cdot5=3,75\); Valor  \(Q_3:\) \(6+0,75(8-6)=7,5\)  -->

<!-- \vspace{0.5cm} -->
<!-- \noindent \textbf{Excel} dispone de la función CUARTIL que identifica la posición de los cuartiles mediante las expresiones: \(0,25(n-1)+1\) y \(0,75(n-1)+1\) y los calcula interpolando igual que hace Minitab. Seguramente no satisfechos con su forma de identificar los cuartiles, en las últimas versiones se ha mantenido esa función (se indica que por compatibilidad con \index{cuartiles!cálculo con Excel} versiones anteriores) y se han añadido: -->

<!-- \begin{itemize}[leftmargin=*] -->
<!-- 	\itemsep0em  -->
<!-- 	\item CUARTIL.INC: Coincide con la función CUARTIL. -->
<!-- 	\item CUARTIL.EXC: Identifica los cuartiles de la misma forma que Minitab. -->
<!-- \end{itemize} -->

<!-- \noindent En la figura \ref{Figura020704} se muestran los cuartiles de nuestros datos con las funciones de Excel (versión 2019). -->

<!-- \begin{figure} [h] -->
<!-- 	%\captionsetup{font=small,labelfont=it} -->
<!-- 	\centering -->
<!-- 	\includegraphics[scale = 0.7]{\MyPath/LibroResp_2_EstDesc/0207 Cuartiles_4.png} -->
<!-- 	\caption{\small{\textit{Cálculo de los cuartiles con Excel}}} -->
<!-- 	\label{Figura020704} -->
<!-- \end{figure} -->

<!-- \noindent En resumen, los valores obtenidos con los métodos comentados han sido: -->
<!-- \vspace{0.4cm} -->
<!-- {\small -->
<!-- \begin{center} -->
<!-- 	\begin{tabular}{ lccccc } \hline -->
<!-- 		\multirow{2}{3em}{Método} & \multicolumn{2}{l}{Datos: 2, 4, 6, 8} & &  \multicolumn{2}{c}{Datos: 2, 4, 6, 8, 10} \\ -->
<!-- 		 & \(\;\;\;\;Q_1\) & \(Q_3\) & \(\;\) & \(\;\;\;\;\;\;\;\;Q_1\) & \(Q_3\) \\ -->
<!-- 		\hline -->
<!-- 		Tukey & \(\;\;\) 3 & 7 & & \(\;\;\;\;\;\;\) 4 & 8 \\  -->
<!-- 		Moore y McCabe \(\;\;\;\) & \(\;\;\) 3 & 7 & & \(\;\;\;\;\;\;\) 3 & 9 \\  -->
<!-- 		Minitab & \(\;\;\) 2,5 & 7,5 & &\(\;\;\;\;\;\;\) 3 & 9 \\ -->
<!-- 		Excel, CUARTIL.INC &\(\;\;\) 3,5 & 6,5 & & \(\;\;\;\;\;\;\) 4 & 8 \\ -->
<!-- 		Excel, CUARTIL.EXC &\(\;\;\) 2,5 & 7,5 & & \(\;\;\;\;\;\;\) 3 & 9 \\ -->
<!-- 		\hline  -->
<!-- 	\end{tabular} -->
<!-- \end{center}}  -->

<!-- \vspace{0.4cm} -->
<!-- \noindent ¿Qué método es el correcto? ¿Cuál debemos utilizar? \textbf{En la práctica no importa demasiado}. Solo se está interesado en conocer los cuartiles cuando el conjunto de datos es grande (nunca si tenemos solo 4 o 5 datos) y en este caso las diferencias entre los distintos métodos no son relevantes. Por ejemplo, si tenemos 500 valores, la posición del primer cuartil con el método de Minitab es 125,25 y con la función CUARTIL.INC de Excel es 125,75. Como habrá poca diferencia entre los valores que ocupan las posiciones 125 y 126, la diferencia en el valor del cuartil no será relevante. -->
