...
Suponga que tiene delante 4 gatos con los siguientes pesos: 1,5; 2,0; 6,0; 6,5 kg. Y ahora piense en 4 vacas cuyos pesos son: 490, 495, 505, 510 kg. ¿En que grupo de animales hay más variabilidad? seguramente pensará que en el del los gatos, donde uno pesa más 4 veces mlo que pesa otro, sin embargo verá las vacas practicamente iguales. Pero si calcula las desviaciones típicas obtendrá:

$$ s_{gatos} = 2,61\, kg$$
$$ s_{vacas} = 9,13\, kg$$
Es mayor la desviación típica del peso de las vacas. Esto es así porque las diferencias de cada uno de los valores respecto a la media (4 en el caso de los gatos y 500 en el de las vacas) son para los gatos: 2,5; 2,0; 2,0; 2,5 y para las vacas: 10, 5, 5, 10. Como estas diferencia son mayores en el caso de las vacas, su desviación típica es mayor.

En un caso como este lo que interesa es la variabilidad respecto a la media, y para medir ese aspecto de los datos usamos el coeficiente de variación $CV$ que se define como:

$$CV = \frac{s}{\bar{x}}$$
Con frecuentcia ese valor se multiplica por 100 para darlo como porcentaje. EN nuestro ejemplo, para los gatos tenemos un $CV$ del 65,35% mientras que para las vacas es solo del 1,83%.

Cuando se informa sobre las características de un conjunto de datos, la desviación típica suele ir acompañada de la media ya que esos dos valroes --conjuntamente-- dicen mucho de los datos. El coeficiente de variación puede ir solo poque incluye información de los dos, aunque nos perdemos sus valroes concretos ===Esto hay que mejorarlo o quitarlo===
