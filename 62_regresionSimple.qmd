...
En general, los paquetes de software estadístico además de presentar los coeficientes del modelo también presentan los $p$-valores asociados a los contrastes que hemos comentado. 

![Distribución de los coeficientes.](Figuras/salidaSoftwareRegresion.png){#fig-pruebasSignificacion fig-align="center" width="100%"}

También puede interesar contrastar otros valores para la pendiente de la recta. Por ejemplo, para verificar que un aparato mide correctamente la concentración de monoxido de carbono (CO) en el aire, se mide la concentración de 11 muestras con valores conocidos



+----------------+-----+----+----+
| Valor real (ppm)   |0    | 10 | 20 |
+----------------+-----+----+----+
| Valor medido (ppm) |1    | 11 | 21 |
+----------------+-----+----+----+
