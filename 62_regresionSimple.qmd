...
Una prueba de significación es un caso particular de contraste de hipótesis donde se contrasta que el valor del parámetro considerado es igual a cero. Significación equivale a "significativamente distinto de cero" es decir, que la variabilidad aleatoria no justifica la diferencia respecto a cero
:

![Distribución de los coeficientes.](regresionSimple/200_pruebasSignaficacion.png){#fig-regreRangoX fig-align="center" width="100%"}
