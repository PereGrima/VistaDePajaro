...
Conocer la distribución de los coeficientes nos permite realizar contrastes de hipótesis sobre el valor de los parámetros estimados, en nuestro caso $\beta_0$ y $\beta_1$.
...
$$ \frac{b_0}{s_{\beta_0}} \sim t-\text{Student} \;\text{con} \; n-2 \; \text{grados de libertad} $$
