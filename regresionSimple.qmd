...
$$ \frac{\partial S}{\partial b_0} = -2 \sum_{í=1}^n \left(y_i - b_0 - b_1 x_i \right ) = 0$$
$$ \frac{\partial S}{\partial b_1} = -2 \sum_{í=1}^n \left(y_i - b_0 - b_1 x_i \right ) x_i = 0$$
Igualando a cero estas expresiones:

$$ \sum_{í=1}^n \left(y_i - b_0 - b_1 x_i \right ) = 0 $$ {#eq-derivada_b0}
