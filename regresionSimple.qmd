...
Si la recta debe pasar por el origen su ecuación será: $y = b_1 X$. Para deducir la expresión de $b_1$ solo hay que minimizar: $S = \sum (y_i -b_1x_i)^2$ y siguiendo el procedimiento habitual tenemos:
...
\noindent Está claro que la segunda derivada es positiva (es una suma de cuadrados) por lo que tendremos un mínimo. Igualando a cero y despejando el valor de $b_1$ se obtiene: $$b_1 = \frac{\sum x_iy_i}{\sum x_i^2} $$
