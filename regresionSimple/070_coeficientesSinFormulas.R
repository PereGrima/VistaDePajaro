# PARA LA FIGURA, NO PARA EL CALCULO EXACTO
...
png("070_coeficientesSinFormulas.png", width=1800, height=950, res = 300)
...
mtext('Recta ajustada a ojo', side=3, line=0.4, cex=0.85, las=0, family = "serif")
grid()

lines(c(-4.75, 5.75), c(0, 60))
#abline(lm(datos$Y~datos$X), col = "red")
# legend(-6, 60, legend=c("A ojo"),
#        col=c("black"), lty=1, xpd = NA, cex = 0.75)
