...
png(file="sumaValorAbsoluto.png",width=1800, height=950, res = 300)
...
axis(side=2, hadj=0.2, tck=-0.02, at=seq(10, 12, 2), cex.axis = 0.9, las = 1)
...
mtext('Valores de X', side=1, line=1.1, cex=0.9, las=1, family = "serif")
mtext('Valores de Y', side=2, line=1.1, cex=0.9, las=0, family = "serif")
text(6.5, 13.7, TeX("$ Y = 12 - 0.5X$"), xpd = NA)
